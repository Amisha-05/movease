...
const token =jwt.sign({id:validUser._id},process.env.JWT_SECRET);//jwt secret ko private rakhna hai isliye env me daala jo deploy krne time kaam aayega 
const {password:pass,...rest}=validUser._doc;//except password we dont want anything in return(check insomnia)
res
