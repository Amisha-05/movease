...
export default function About() {
  return (
    <div className='py-20 px-4 max-w-6xl mx-auto'>
      <h1 className='text-4xl font-bold mb-8 text-gray-800 font-custom flex items-center mr-0'> {/* Add flex and items-center classes */}
        About Movease
     {/* Adjust size and margin-left for spacing */}
      </h1>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div>
          <p className='mb-4 text-lg text-slate-900 font-custom'>
